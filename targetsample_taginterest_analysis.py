...
def tag_analysis(target_tag):
    ...
    with open("E621_data/globalaverage_taginterest.json") as f:
        data = json.load(f)
    ...
    print("Global interest for tag:", global_interest)
    print("Number of users above global average:", len(tag_enjoyer_dict))
    print("Subset interests before filtering:", subset_interests)
